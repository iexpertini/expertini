(function ($) {
  ...
  //$('.call-model-register').on('click', function(event) {
  ...
  // Open modal in AJAX callback
  $(".call-model-login").on("click", function (event) {
    event.preventDefault();
    this.blur();
    $.get(this.href, function (html) {
      $(html).appendTo("body").modal({
  ...
  if ($("#email-form").length) {
    $("#submit").click(function () {
      ...
      $.ajax({
        ...
        beforeSend: function () {
          $("#email-form .response").html(
            '<div class="text-info"><img src="https://cdn.expertini.com/images/icons/preloader.gif"> Loading...</div>'
          );
        },
...
// For dashboard sidebar top calculation
// var w = window.innerWidth;

// if (w < 1200) {
//   let mobile_header = document.querySelector(".mobile-header");
//   let height = mobile_header.offsetHeight;
//   console.log(height);
//   var sidebar = document.querySelector(".user-sidebar");
//   sidebar.style.position = "fixed";
//   sidebar.style.top = height.toString() + "px";
// }
